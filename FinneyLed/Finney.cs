...
// ***********************************************************************
// <copyright file="Finney.cs" company="Zeroit Dev Technologies">
...
{
    /// <summary>
    /// A class collection for emulating a LED displayer
    /// </summary>
    /// <seealso cref="System.Windows.Forms.Control" />
    /// <seealso cref="System.ComponentModel.ISupportInitialize" />
    public class ZeroitLedLabel : Control, ISupportInitialize
    {
        #region Nested Types
        /// <summary>
        ...
        #region Constructor
        /// <summary>
        /// Initializes a new instance of the <c><see cref="ZeroitLedLabel" /></c> class.
        /// </summary>
        public ZeroitLedLabel()
        {
            // double buffered
        ...
        /// <param name="segmentWidth">Width of the segment.</param>
        /// <param name="segmentInterval">The segment interval.</param>
        private void DrawChars(Graphics g, float segmentWidth, float segmentInterval)
        {
            ...
            for (int i = 0; i < totalElements; ++i)
            {
                ...
                if (m_enumAlign == Alignment.Left)
                {
                    if (i < Text.Length)
                    {
                        DrawSingleCharWithFadedBk(g, subRect, ForeColor, m_colFadedColor, Text[i],
                            m_fBevelRate, segmentWidth, segmentInterval);
                    }
                    else
                    {
                        DrawSingleChar(g, subRect, m_colFadedColor, '8', m_fBevelRate, segmentWidth,
                                segmentInterval);
                    }
                }
                else
                {
                    ...
                    {
                        DrawSingleCharWithFadedBk(g, subRect, ForeColor, m_colFadedColor, Text[i - beginIndex_right],
                            m_fBevelRate, segmentWidth, segmentInterval);
                    }
                    else
                    {
            ...
            Color col2, Color colBorder, int nBorderWidth, bool bGradient, bool bDrawBorder)
        {
            ...
            {
                br = new System.Drawing.SolidBrush(col1);
            }
        ...
        private void DrawBackground(Graphics g)
        {
            ...
            Color borderColor = this.Focused ? m_colFocusedBorderColor : m_colBorderColor;
            if (m_bRoundRect)
            {
                DrawRoundRect(g, rect, m_nCornerRadius, BackColor[0], BackColor[1],
                    borderColor, m_nBorderWidth, m_bGradientBackground, m_nBorderWidth != 0);
            }
            else
            {
                if (BackColor[0] == Color.Transparent)
                    return;
                DrawNormalRect(g, rect, BackColor[0], BackColor[1],
                    borderColor, m_nBorderWidth, m_bGradientBackground, m_nBorderWidth != 0);
            }
        }
        /// <summary>
        ...
        /// </summary>
        private Color[] m_colCustomBk = new Color[]
        {
            Color.Transparent,
            Color.DimGray
        ...
        /// </summary>
        /// <value><c>true</c> if [use italic style]; otherwise, <c>false</c>.</value>
        [System.ComponentModel.Browsable(true),
        System.ComponentModel.Category("Appearance"),
        System.ComponentModel.Description("Turn on/off the italic text style."),
        ...
        /// </summary>
        /// <value><c>true</c> if [use smoothing mode]; otherwise, <c>false</c>.</value>
        [System.ComponentModel.Browsable(true),
        System.ComponentModel.Category("Appearance"),
        System.ComponentModel.Description("Turn on/off the smoothing mode."),
        System.ComponentModel.DefaultValue(false)]
        ...
        /// <exception cref="ArgumentException">This value should be between 0 and 5</exception>
        [System.ComponentModel.Browsable(true),
        System.ComponentModel.Category("Appearance"),
        ...
        [System.ComponentModel.Browsable(true),
        System.ComponentModel.Category("Appearance"),
        System.ComponentModel.Description("Set the border color"),
        ...
        /// </summary>
        /// <value>The color of the focused border.</value>
        [System.ComponentModel.Browsable(true),
        System.ComponentModel.Category("Appearance"),
        System.ComponentModel.Description("Set the focused border color."),
        System.ComponentModel.DefaultValue(typeof(System.Drawing.Color), "Cyan")]
        public Color FocusedBorderColor
        {
            get
            {
                return m_colFocusedBorderColor;
            }
            set
            {
        ...
        /// </summary>
        /// <value>The highlight opaque.</value>
        /// <exception cref="ArgumentException">This value should be between 0 and 50</exception>
        [System.ComponentModel.Browsable(true),
        System.ComponentModel.Category("Appearance"),
        System.ComponentModel.Description("Set the opaque value of the highlight"),
        ...
        /// </summary>
        /// <value><c>true</c> if [show highlight]; otherwise, <c>false</c>.</value>
        [System.ComponentModel.Browsable(true),
        System.ComponentModel.Category("Appearance"),
        System.ComponentModel.Description("Set whether to show highlight area on the control"),
        System.ComponentModel.DefaultValue(false)]
        ...
        /// <exception cref="ArgumentException">This value should be between 1 and 10</exception>
        [System.ComponentModel.Browsable(true),
        System.ComponentModel.Category("Appearance"),
        System.ComponentModel.Description("Set the corner radius for the background rectangle."),
        ...
        /// </summary>
        /// <value><c>true</c> if [gradient background]; otherwise, <c>false</c>.</value>
        [System.ComponentModel.Browsable(true),
        System.ComponentModel.Category("Appearance"),
        System.ComponentModel.Description("Set if the background was filled in gradient colors"),
        System.ComponentModel.DefaultValue(false)]
        ...
        [System.ComponentModel.Browsable(true),
        System.ComponentModel.Category("Appearance"),
        System.ComponentModel.Description("Set thr first custom background color"),
        System.ComponentModel.DefaultValue(typeof(System.Drawing.Color), "System.Drawing.Color.Black")]
        public new Color[] BackColor
        {
            get
            {
                return m_colCustomBk;
            }
            set
            {
                m_colCustomBk = value;
        ...
        //[System.ComponentModel.Browsable(true),
        //System.ComponentModel.Category("Appearance"),
        //System.ComponentModel.Description("Set thr second custom background color"),
        //System.ComponentModel.DefaultValue(typeof(System.Drawing.Color), "System.Drawing.Color.DimGray")]
        ...
        /// </summary>
        /// <value><c>true</c> if [round corner]; otherwise, <c>false</c>.</value>
        [System.ComponentModel.Browsable(true),
        System.ComponentModel.Category("Appearance"),
        System.ComponentModel.Description("Set the background bound style"),
        System.ComponentModel.DefaultValue(false)]
        ...
        /// </summary>
        /// <value>The segment interval ratio.</value>
        /// <exception cref="ArgumentException">This value should be between 0 and 100</exception>
        [System.ComponentModel.Browsable(true),
        System.ComponentModel.Category("Behavior"),
        System.ComponentModel.Description("Set segment interval ratio"),
        ...
        System.ComponentModel.DefaultValue(typeof(Alignment), "Left")]
        ...
        /// </summary>
        /// <value>The segment width ratio.</value>
        /// <exception cref="ArgumentException">This value should be between 0 and 100</exception>
        [System.ComponentModel.Browsable(true),
        System.ComponentModel.Category("Behavior"),
        System.ComponentModel.Description("Set the segment width ratio"),
        System.ComponentModel.DefaultValue(50)]
        ...
        /// </summary>
        /// <value>The total character count.</value>
        /// <exception cref="ArgumentException">This value should be greater than 2.</exception>
        [System.ComponentModel.Browsable(true),
        System.ComponentModel.Category("Behavior"),
        System.ComponentModel.Description("Set the total number of characters to display"),
        System.ComponentModel.DefaultValue(5)]
        ...
        /// </summary>
        /// <value>The bevel rate.</value>
        /// <exception cref="ArgumentException">This value should be between 0.0 and 1</exception>
        [System.ComponentModel.Browsable(true),
        System.ComponentModel.Category("Behavior"),
        System.ComponentModel.Description("Set the bevel rate of each segment"),
        ...
        /// </summary>
        /// <value>The color of the faded.</value>
        [System.ComponentModel.Browsable(true),
        System.ComponentModel.Category("Appearance"),
        System.ComponentModel.Description("Set the color of background characters"),
        System.ComponentModel.DefaultValue(typeof(Color), "System.Color.DimGray")]
        ...
        [System.ComponentModel.Browsable(true),
        System.ComponentModel.Category("Appearance"),
        System.ComponentModel.Description("Set text of the control"),
        ...
        void EvClick(object sender, EventArgs e)
        {
            this.Focus();
        }
        ...
        void EvKeyDown(object sender, KeyEventArgs e)
        {
        ...
        /// <param name="sender">The sender.</param>
        /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
        void EvFocus(object sender, EventArgs e)
        {
            this.Invalidate();
        }
